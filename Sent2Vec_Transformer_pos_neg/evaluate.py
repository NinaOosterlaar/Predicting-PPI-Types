...
def evaluate(model, iterator, criterion):
    ...
    return epoch_loss / len(iterator), epoch_acc / len(iterator), roc_auc_score(lab,pred), lab, pred, final
...
if __name__ == '__main__':    
    ...
    loss, acc, roc, lab, pred, final = evaluate(model, c_val_grt, criterion)
    print(acc, roc)
