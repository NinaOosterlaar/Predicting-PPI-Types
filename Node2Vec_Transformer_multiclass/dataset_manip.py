...
def get_dataset_split_stringDB(interactions, go_id_dict_pth, go_embed_pth, shuffle, aliases_path = "", ratio = [0.8, 0.2, 0],\
                               stringDB = True, organism = [0], go_name_space_dict_pth = "datasets/transformerGO-dataset/go-terms/go_namespace_dict", 
    ...
    full_dataset = Dataset_stringDB(all_ppi, labels, protein_go_anno, go_id_dict_pth, go_embed_pth, shuffle, aliases_path, stringDB)
